...
class ConsultationController extends Controller
{
    ...
    public function createAction(Request $request, $type)
    {
        ...
        if ($form->isValid()) {
            ...
            $this->get('session')->getFlashBag()->add('info', "Consultation successfully saved.");
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        $this->get('session')->getFlashBag()->add('danger', "Errors when submitting the form !");
        return $this->render('BenDoctorsBundle:Consultation:edit.html.twig', array(
            'entity'      => $entity,
            'form'   => $editForm->createView(),
            'delete_form' => $deleteForm->createView(),
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        if ($form->isValid()) {
            ...
            if ($currentUser != $entity->getUser() && !$this->get('security.context')->isGranted('ROLE_ADMIN'))
                ...
                $em->remove($entity);
                $em->flush();
                $this->get('session')->getFlashBag()->add('info', "Request sent !");
            }
        }
