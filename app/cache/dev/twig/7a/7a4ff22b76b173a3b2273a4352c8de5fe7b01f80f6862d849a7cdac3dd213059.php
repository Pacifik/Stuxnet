...
";
    ...
    {
        // line 6
        echo "<div class=\"col-md-12\"><h3><span class=\" glyphicon glyphicon-user\"></span> User registration</h3></div>
...
";
    ...
    <div class=\"form-group\">
      <div class=\"col-sm-offset-6 col-sm-6\">
        <button type=\"submit\" name=\"subvalider\" class=\"btn btn-primary\"><span class=\"glyphicon glyphicon-plus\"></span> Add</button>
      </div>
    </div>
</form>
";
...
{% endblock %}
{% block body %}
<div class=\"col-md-12\"><h3><span class=\" glyphicon glyphicon-user\"></span> User registration</h3></div>
