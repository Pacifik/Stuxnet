...
<div id=\"mycontainer\" class=\"row\">
    <div class=\"col-md-10\">    
        ...
        if ( !$this->getAttribute(($context["entity"] ?? $this->getContext($context, "entity")), "isSpecial", array())) {
            ...
            <h3>List of performed consultations 
        ...
        echo "            <div class=\"col-md-5\">
                <h3>Delivered medications <a class=\"btn btn-info btn-sm pull-right\" href=\"";
        // line 141
...
<div id=\"mycontainer\" class=\"row\">
    <div class=\"col-md-10\">    
        ...
        {% endif %}
            <div class=\"col-md-5\">
                <h3>Delivered medications <a class=\"btn btn-info btn-sm pull-right\" href=\"{{ path('consultation_edit', { 'id': entity.id }) }}\"> <span class=\"glyphicon glyphicon-plus\"></span></a></h3>
    ...
    <div class=\"col-md-2\">
        <form id=\"deleteForm\" action=\"{{ path('consultation_delete', { 'id': entity.id }) }}\" method=\"DELETE\">
            ...
            <a class=\"btn btn-info btn-block\" href=\"{{ path('consultation_edit', { 'id': entity.id }) }}\">Update</a>
            <a class=\"btn btn-info btn-block\" id=\"btnPrint\"><span class=\"glyphicon glyphicon-print\"></span> Print</a>
            <hr>
            <button class=\"btn btn-danger btn-block\" type=\"submit\">Delete</button>
