...
";
    ...
    {
        // line 6
        echo "<h3><span class=\"glyphicon glyphicon-cog\"></span> Preferences</h3>
<form class=\"form-horizontal\" action=\"";
    ...
    <div class=\"tabbable\">
        <ul class=\"nav nav-tabs\">
          ...
          <li><a href=\"#tab2\" data-toggle=\"tab\"><span class=\"glyphicon glyphicon-wrench\"></span> Settings</a></li>
        </ul> <!-- /tabs -->
    ...
    <div class=\"tab-content\">
        ...
        echo "
        <div class=\"form-group\">
          <label for=\"\" class=\"col-md-4 control-label\">Application</label>
          <div class=\"col-md-4\">
        ...
        <div class=\"form-group\">
          <label for=\"\" class=\"col-md-4 control-label\">Adress</label>
          <div class=\"col-md-4\">
        ...
        <div class=\"form-group\">
          <label for=\"\" class=\"col-md-4 control-label\">Zip code</label>
          <div class=\"col-md-4\">
        ...
        <div class=\"form-group\">
          <label for=\"\" class=\"col-md-4 control-label\">Cell </label>
          <div class=\"col-md-4\">
        ...
        <div class=\"form-group\">
          <label for=\"\" class=\"col-md-4 control-label\">Office number </label>
          <div class=\"col-md-4\">
       ...
       <div class=\"form-group\">
         <div class=\"col-md-offset-4 col-md-4\">
           <button type=\"submit\" name=\"subvalider\" class=\"btn btn-primary btn-embossed\"><span class=\"fui-check-inverted\"></span> Update</button>
         </div>
       </div>
</form>
...
{% endblock %}
{% block body %}
<h3><span class=\"glyphicon glyphicon-cog\"></span> Preferences</h3>
