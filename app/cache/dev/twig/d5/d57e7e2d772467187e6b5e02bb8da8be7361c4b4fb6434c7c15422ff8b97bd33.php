...
class __TwigTemplate_c83ac8de735dd00321dd45837e7c586562ee518e66cd39602ae0134cd5f15fa3 extends Twig_Template
{
  ...
  ";
        // line 8
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "username", array()), 'row', array("label" => "Status"));
        echo "
  ";
        // line 9
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "plainpassword", array()), 'row', array("label" => "Password"));
        echo "
  ";
        // line 10
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "family_name", array()), 'row', array("label" => "Surname"));
        echo "
  ";
        // line 11
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "first_name", array()), 'row', array("label" => "Firstname"));
        echo "
  ";
        // line 12
  ...
  ";
        // line 14
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "enabled", array()), 'row', array("label" => "Activate"));
        echo "
  ";
        // line 15
  ...
  {{ form_row(form.username, { 'label': 'Status'}) }}
  {{ form_row(form.plainpassword, { 'label': 'Password'}) }}
  {{ form_row(form.family_name, { 'label': 'Surname'}) }}
  {{ form_row(form.first_name, { 'label': 'Firstname'}) }}
  {{ form_row(form.email, { 'label': 'E-mail'}) }}
  {{ form_row(form.tel, { 'label': 'Cell'}) }}
  {{ form_row(form.enabled, { 'label': 'Activate'}) }}
