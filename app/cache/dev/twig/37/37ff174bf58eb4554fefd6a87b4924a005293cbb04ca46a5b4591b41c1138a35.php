...
class __TwigTemplate_1af42df6fa9514e2d2b4b2243ba7ae9d6729dd341489c280eb189bfe251a9d20 extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_5abf141e79238384bc0f64aad80835a4040c1fe9e819225137724df96fc29e6d"] = $this;
        // line 1
    ...
    <table>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["listener"]) {
            ...
            echo "</code></td>
                <td><code>";
            // line 34
            echo $context["__internal_5abf141e79238384bc0f64aad80835a4040c1fe9e819225137724df96fc29e6d"]->getdisplay_listener($context["listener"]);
            echo "</code></td>
            </tr>
        ";
        }
        ...
        if ($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "notcalledlisteners", array())) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["listener"]) {
                ...
                echo "</code></td>
                    <td><code>";
                // line 51
                echo $context["__internal_5abf141e79238384bc0f64aad80835a4040c1fe9e819225137724df96fc29e6d"]->getdisplay_listener($this->getAttribute(($context["listeners"] ?? $this->getContext($context, "listeners")), $context["listener"], array(), "array"));
                echo "</code></td>
                </tr>
            ";
            }
...
{% macro display_listener(listener) %}
    ...
    {% endif %}
{% endmacro %}
", "@WebProfiler/Collector/events.html.twig", "/home/pacifik/Dev./Stuxnet/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/events.html.twig");
    }
}
