...
class __TwigTemplate_3904a83f3945511c5a7e85c4c82aa69a48a08094b3b1066b255974f012329a29 extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_66bc702735cd7e3bd9a59bf10f92873841fd16ef6b10347dd6efcf1a46a27c18"] = $this;
        // line 1
    ...
    <table>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["listener"]) {
            ...
            echo "</code></td>
                <td><code>";
            // line 34
            echo $context["__internal_66bc702735cd7e3bd9a59bf10f92873841fd16ef6b10347dd6efcf1a46a27c18"]->getdisplay_listener($context["listener"]);
            echo "</code></td>
            </tr>
        ";
        }
        ...
        if ($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "notcalledlisteners", array())) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["listener"]) {
                ...
                echo "</code></td>
                    <td><code>";
                // line 51
                echo $context["__internal_66bc702735cd7e3bd9a59bf10f92873841fd16ef6b10347dd6efcf1a46a27c18"]->getdisplay_listener($this->getAttribute(($context["listeners"] ?? $this->getContext($context, "listeners")), $context["listener"], array(), "array"));
                echo "</code></td>
                </tr>
            ";
            }
...
{% macro display_listener(listener) %}
    ...
    {% endif %}
{% endmacro %}
", "@WebProfiler/Collector/events.html.twig", "/home/pacifik/Desktop/Doctors-master/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/events.html.twig");
    }
}
