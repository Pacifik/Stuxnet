...
class __TwigTemplate_334bb4332525e3c45243024c9e4d413e73c56e15304896bf3d094da3cbdbe7da extends Twig_Template
{
...
";
    ...
    ";
        ...
        if ($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "logs", array())) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["log"]) {
                if ((((($context["priority"] ?? $this->getContext($context, "priority")) >= 0) && ($this->getAttribute($context["log"], "priority", array()) >= ($context["priority"] ?? $this->getContext($context, "priority")))) || ((($context["priority"] ?? $this->getContext($context, "priority")) < 0) && ((($this->getAttribute($this->getAttribute($context["log"], "context", array(), "any", false, true), "type", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($context["log"], "context", array(), "any", false, true), "type", array()), 0)) : (0)) == ($context["priority"] ?? $this->getContext($context, "priority")))))) {
                    // line 92
                    echo "                <li class=\"";
    ...
    public function getdisplay_message($__log_index__ = null, $__log__ = null, ...$__varargs__)
    {
        ...
        try {
            // line 108
            echo "    ";
            if ((twig_constant("Symfony\\Component\\Debug\\ErrorHandler::TYPE_DEPRECATION") == (($this->getAttribute($this->getAttribute(($context["log"] ?? null), "context", array(), "any", false, true), "type", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute(($context["log"] ?? null), "context", array(), "any", false, true), "type", array()), 0)) : (0)))) {
                // line 109
                echo "        DEPRECATION -  ";
        ...
        ";
                // line 115
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute(($context["log"] ?? $this->getContext($context, "log")), "context", array()), "stack", array()));
            ...
            ";
                        // line 131
                        if (($context["index"] == (twig_length_filter($this->env, $this->getAttribute($this->getAttribute(($context["log"] ?? $this->getContext($context, "log")), "context", array()), "stack", array())) - 1))) {
                            // line 132
                            echo "                </ul>
            ";
                        }
                ...
                // line 136
                echo "        ";
                echo twig_escape_filter($this->env, $this->getAttribute(($context["log"] ?? $this->getContext($context, "log")), "priorityName", array()), "html", null, true);
                echo " - ";
                echo twig_escape_filter($this->env, $this->getAttribute(($context["log"] ?? $this->getContext($context, "log")), "message", array()), "html", null, true);
                echo "
        ";
...
{% macro display_message(log_index, log) %}
    ...
    {% endif %}
{% endmacro %}
", "@WebProfiler/Collector/logger.html.twig", "/home/pacifik/Desktop/Doctors-master/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/logger.html.twig");
    }
}
