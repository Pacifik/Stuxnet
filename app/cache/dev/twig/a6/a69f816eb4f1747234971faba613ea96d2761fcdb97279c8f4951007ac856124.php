...
<form class=\"form-horizontal col-md-8\" action=\"";
  ...
  ";
        // line 20
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "tel", array()), 'row', array("label" => "Phone number"));
        echo "
  ";
        // line 21
...
<form class=\"form-horizontal col-md-8\" action=\"{{ path('ben_profile_update', { 'id': entity.id }) }}\" method=\"post\" {{ form_enctype(form) }}>
  ...
  {{ form_row(form.tel, { 'label': 'Phone number'}) }}
  {{ form_rest(form) }}
