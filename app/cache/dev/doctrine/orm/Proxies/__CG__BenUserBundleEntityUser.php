...
class User extends \Ben\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Ben\\UserBundle\\Entity\\User' . "\0" . 'family_name', '' . "\0" . 'Ben\\UserBundle\\Entity\\User' . "\0" . 'first_name', '' . "\0" . 'Ben\\UserBundle\\Entity\\User' . "\0" . 'tel', 'created', 'lastActivity', '' . "\0" . 'Ben\\UserBundle\\Entity\\User' . "\0" . 'image', 'consultations', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
