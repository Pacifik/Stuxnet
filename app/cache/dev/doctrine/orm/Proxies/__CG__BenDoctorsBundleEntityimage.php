 ...
 */
class image extends \Ben\DoctorsBundle\Entity\image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Ben\\DoctorsBundle\\Entity\\image' . "\0" . 'id', 'path', '' . "\0" . 'Ben\\DoctorsBundle\\Entity\\image' . "\0" . 'file', '' . "\0" . 'Ben\\DoctorsBundle\\Entity\\image' . "\0" . 'filenameForRemove'];
        }

        return ['__isInitialized__', '' . "\0" . 'Ben\\DoctorsBundle\\Entity\\image' . "\0" . 'id', '' . "\0" . 'Ben\\DoctorsBundle\\Entity\\image' . "\0" . 'file', '' . "\0" . 'Ben\\DoctorsBundle\\Entity\\image' . "\0" . 'filenameForRemove'];
    }
