 ...
 */
class Meds extends \Ben\DoctorsBundle\Entity\Meds implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Ben\\DoctorsBundle\\Entity\\Meds' . "\0" . 'id', '' . "\0" . 'Ben\\DoctorsBundle\\Entity\\Meds' . "\0" . 'name', '' . "\0" . 'Ben\\DoctorsBundle\\Entity\\Meds' . "\0" . 'count', '' . "\0" . 'Ben\\DoctorsBundle\\Entity\\Meds' . "\0" . 'type', '' . "\0" . 'Ben\\DoctorsBundle\\Entity\\Meds' . "\0" . 'about', 'created', 'expdate', 'consultationmeds'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Meds $proxy) {
    ...
    public function minusCount($count)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'minusCount', [$count]);

        return parent::minusCount($count);
    }
